...
class DiskResource(LoggedRestResource):
    ...
    def get_query(self):
        ...
        if g.user and g.user.admin:
            ...
            return self.model.select().where(self.model.avail_type != "Draft" and self.model.avail_type != "ShoppingVoting")
...
api.register(Shopping, ShoppingResource, auth=user_auth)
